...
from support_db import save_support_ticket  # NEW
    ...
    with st.form("escalation_form"):
        ...
        if submitted:
            if not name or not email or not issue_details:
                ...
                st.success("✅ Your request has been submitted. Our team will contact you shortly.")
                st.session_state.escalation_active = False
...
"""
    ...
    if escalation_required:
        ...
        # Save the triggering query in history
        new_entry = {
            "query": user_query,
